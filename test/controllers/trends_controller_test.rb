...
class TrendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trend" do
    assert_difference('Trend.count') do
      post trends_url, params: { trend: { description: @trend.description, title: @trend.title } }
    end
  ...
  test "should update trend" do
    patch trend_url(@trend), params: { trend: { description: @trend.description, title: @trend.title } }
